<template>
    <nav class="fixed w-[100%] h-[60px] flex items-center bg-[#faf6e9] shadow-lg">
    ...
    <aside :class="{'left-[-999px]': !stateNav.isChange.value, 'left-0': stateNav.isChange.value}"
        class="absolute w-[280px] h-[100%] bg-[#fffdf6] shadow-xl transition-all ease-in-out duration-700"
    >
